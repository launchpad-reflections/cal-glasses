"""
Tap + → Scan food → explore camera screen for photo library option.
"""
import time
...
time.sleep(3)  # Camera takes a moment to load

dump(driver, "CAMERA SCREEN")
driver.save_screenshot("3_camera.png")
